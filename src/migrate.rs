...
/////////////////////METODO DE MIGRACIÖN
    ...
    pub fn migrate() -> Self {
        ...
        Self {
            ...
            countdown_period: old_state.countdown_period,
            countdown_period_withdraw: old_state.countdown_period_withdraw,
            account_last_deposit: old_state.account_last_deposit,
            ...
            vaults: old_state.vaults,
            treasury_fee: old_state.treasury_fee
        }
    }
